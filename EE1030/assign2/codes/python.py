...
def read_vertices(filename):
    """Reads vertices from a file using numpy and returns them as a numpy array."""
...
def plot_parallelogram(vertices):
    """Plots the parallelogram and labels the vertices A, B, C, and D with their coordinates."""
