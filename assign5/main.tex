...
\item The solution of the differential equation $\brak{x^2+y^2}$d$x$-$5xy$d$y=0$, $y\brak{1}=0,$ is :
      ...
      \end{enumerate}
\item A variable line $L$ passes through the point $\vec{3\\5}$ and intersects the positive coordinate axes at the points $A$ and $B$. The minimum area of the triangle $OAB$, where $O$ is the origin, is:
     \begin{enumerate}
